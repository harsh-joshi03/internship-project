...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      setError(err.response?.data?.message || 'Server error. Failed to add product.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="container my-5" style={{ maxWidth: '700px' }}>
      <div className="d-flex align-items-center gap-3 mb-4">
        ...
        <h3 className="fw-bold text-white mb-0">Add New Product</h3>
      </div>

      <div className="auth-card w-100 p-4">
        <h4 className="fw-bold text-white mb-4 text-center">Guitar Store Catalog Details</h4>
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          <div className="mb-4">
            <label className="input-label-custom d-block mb-1 text-muted fs-7">Product Image *</label>
            <input
              type="file"
              accept="image/*"
